...
###############
    ...
    def test_valid_login(self):
        # add user to db
        test_user = classes.User('First','Last','test@test.com','6158675309','password')
    ...
    def test_invalid_login(self):
        # add user to db
        test_user = classes.User('First','Last','test@test1.com','6158172309','password')
        db.session.add(test_user)
        db.session.commit()
        with self.app as c:
            email = 'test@test.com'
    ...
    def test_email_exists_register(self):
        test_user = classes.User('First','Last','test@test.com','6158172309','password')
        db.session.add(test_user)
        db.session.commit()
        data = {'first_name':'First',
                'last_name':'Last',
